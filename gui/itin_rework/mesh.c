...
Mesh2 * new_mesh() {
	...
	mesh->mesh_box->type = MESHBOX_TRIANGLES;
	mesh->mesh_box->tri.num = 0;
	mesh->mesh_box->tri.cap = 0;
	mesh->mesh_box->tri.triangles = NULL;
...
void rebuild_mesh_boxes(Mesh2 *mesh) {
	...
	if(mesh->mesh_box) free_mesh_box(mesh->mesh_box);
